.class final Landroid/support/v4/app/o$m;
...
.method public final b(Landroid/support/v4/app/o$d;)Landroid/app/Notification;
    ...
    .prologue
    .line 558
    iget-object v0, p1, Landroid/support/v4/app/o$d;->mContext:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/o$d;->db:Landroid/app/Notification;

    iget-object v2, p1, Landroid/support/v4/app/o$d;->cD:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/o$d;->cE:Ljava/lang/CharSequence;

    iget-object v4, p1, Landroid/support/v4/app/o$d;->cJ:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/o$d;->cH:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/o$d;->cK:I

    iget-object v7, p1, Landroid/support/v4/app/o$d;->cF:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/o$d;->cG:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/o$d;->cI:Landroid/graphics/Bitmap;
