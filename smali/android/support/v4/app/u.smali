...
.field private static dB:Ljava/util/Set;

.field private static dD:Landroid/support/v4/app/u$h;

.field public static final dE:Landroid/support/v4/app/u$b;

.field private static final dy:I

.field private static final dz:Ljava/lang/Object;

.field private static final sLock:Ljava/lang/Object;


# instance fields
.field public final dC:Landroid/app/NotificationManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/u;->dz:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v4/app/u;->dB:Ljava/util/Set;
    ...
    sput-object v0, Landroid/support/v4/app/u;->dE:Landroid/support/v4/app/u$b;

    .line 172
    :goto_0
    sget-object v0, Landroid/support/v4/app/u;->dE:Landroid/support/v4/app/u$b;

    invoke-interface {v0}, Landroid/support/v4/app/u$b;->an()I

    move-result v0

    sput v0, Landroid/support/v4/app/u;->dy:I
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/u;->dC:Landroid/app/NotificationManager;
...
.method static synthetic am()I
    ...
    .prologue
    .line 54
    sget v0, Landroid/support/v4/app/u;->dy:I

    return v0
.end method

.method public static h(Landroid/content/Context;)Landroid/support/v4/app/u;
    .locals 1
...
.method public static i(Landroid/content/Context;)Ljava/util/Set;
    ...
    sget-object v0, Landroid/support/v4/app/u;->dA:Ljava/lang/String;
    ...
    .line 247
    :cond_1
    sget-object v2, Landroid/support/v4/app/u;->dz:Ljava/lang/Object;

    monitor-enter v2

    .line 248
    :try_start_0
    sput-object v3, Landroid/support/v4/app/u;->dB:Ljava/util/Set;

    .line 249
    sput-object v1, Landroid/support/v4/app/u;->dA:Ljava/lang/String;
    ...
    .line 252
    :cond_2
    sget-object v0, Landroid/support/v4/app/u;->dB:Ljava/util/Set;
...
.method public final a(Landroid/support/v4/app/u$i;)V
    ...
    .line 268
    :try_start_0
    sget-object v0, Landroid/support/v4/app/u;->dD:Landroid/support/v4/app/u$h;
    ...
    sput-object v0, Landroid/support/v4/app/u;->dD:Landroid/support/v4/app/u$h;
