.class final Landroid/support/v4/app/o$n;
...
.method public final b(Landroid/support/v4/app/o$d;)Landroid/app/Notification;
    ...
    iget-object v1, v0, Landroid/support/v4/app/o$d;->mContext:Landroid/content/Context;

    move-object/from16 v0, p1

    iget-object v2, v0, Landroid/support/v4/app/o$d;->db:Landroid/app/Notification;

    move-object/from16 v0, p1

    iget-object v3, v0, Landroid/support/v4/app/o$d;->cD:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v4, v0, Landroid/support/v4/app/o$d;->cE:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v5, v0, Landroid/support/v4/app/o$d;->cJ:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v6, v0, Landroid/support/v4/app/o$d;->cH:Landroid/widget/RemoteViews;

    move-object/from16 v0, p1

    iget v7, v0, Landroid/support/v4/app/o$d;->cK:I

    move-object/from16 v0, p1

    iget-object v8, v0, Landroid/support/v4/app/o$d;->cF:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v9, v0, Landroid/support/v4/app/o$d;->cG:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v10, v0, Landroid/support/v4/app/o$d;->cI:Landroid/graphics/Bitmap;

    move-object/from16 v0, p1

    iget v11, v0, Landroid/support/v4/app/o$d;->cP:I

    move-object/from16 v0, p1

    iget v12, v0, Landroid/support/v4/app/o$d;->cQ:I

    move-object/from16 v0, p1

    iget-boolean v13, v0, Landroid/support/v4/app/o$d;->cR:Z
