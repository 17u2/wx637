...
# instance fields
.field private bV:Landroid/support/v4/app/d;

.field private final ca:Ljava/util/ArrayList;

.field private cb:Landroid/widget/FrameLayout;

.field private cc:Landroid/widget/TabHost$OnTabChangeListener;

.field private cd:Landroid/support/v4/app/FragmentTabHost$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->ca:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->cb:Landroid/widget/FrameLayout;

    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->cb:Landroid/widget/FrameLayout;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/g;)Landroid/support/v4/app/g;
    ...
    :goto_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->ca:Ljava/util/ArrayList;
    ...
    .line 328
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cd:Landroid/support/v4/app/FragmentTabHost$a;
    ...
    .line 330
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->bV:Landroid/support/v4/app/d;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/g;->c(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/g;
    ...
    iget-object v2, v1, Landroid/support/v4/app/FragmentTabHost$a;->cg:Ljava/lang/Class;

    invoke-virtual {v2}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, v1, Landroid/support/v4/app/FragmentTabHost$a;->ch:Landroid/os/Bundle;
    ...
    invoke-virtual {p2, v0, v2, v3}, Landroid/support/v4/app/g;->a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/g;

    .line 347
    :cond_4
    :goto_2
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->cd:Landroid/support/v4/app/FragmentTabHost$a;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/g;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/g;
...
.method protected onAttachedToWindow()V
    ...
    .line 255
    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->bV:Landroid/support/v4/app/d;

    iget-object v5, v0, Landroid/support/v4/app/FragmentTabHost$a;->tag:Ljava/lang/String;

    invoke-virtual {v4, v5}, Landroid/support/v4/app/d;->i(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    .line 261
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cd:Landroid/support/v4/app/FragmentTabHost$a;
    ...
    .line 266
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->bV:Landroid/support/v4/app/d;
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/FragmentTabHost;->ce:Z

    .line 276
    invoke-direct {p0, v3, v1}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/g;)Landroid/support/v4/app/g;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 301
    iget-object v0, p1, Landroid/support/v4/app/FragmentTabHost$SavedState;->cf:Ljava/lang/String;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/v4/app/FragmentTabHost$SavedState;->cf:Ljava/lang/String;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    .prologue
    .line 306
    iget-boolean v0, p0, Landroid/support/v4/app/FragmentTabHost;->ce:Z
    ...
    .line 312
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cc:Landroid/widget/TabHost$OnTabChangeListener;
...
.method public setOnTabChangedListener(Landroid/widget/TabHost$OnTabChangeListener;)V
    ...
    .prologue
    .line 219
    iput-object p1, p0, Landroid/support/v4/app/FragmentTabHost;->cc:Landroid/widget/TabHost$OnTabChangeListener;
