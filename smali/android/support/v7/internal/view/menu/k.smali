...
.field private mC:Landroid/support/v7/internal/widget/ListPopupWindow;
...
.field private mH:Landroid/support/v7/internal/view/menu/k$a;

.field private mI:Landroid/view/ViewGroup;

.field me:Landroid/support/v7/internal/view/menu/l$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/f;Landroid/view/View;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/k;->hE:Landroid/view/LayoutInflater;

    .line 82
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/k;->iK:Landroid/support/v7/internal/view/menu/f;

    .line 83
    iput-boolean p4, p0, Landroid/support/v7/internal/view/menu/k;->mF:Z
    ...
    iput v0, p0, Landroid/support/v7/internal/view/menu/k;->mD:I

    .line 89
    iput-object p3, p0, Landroid/support/v7/internal/view/menu/k;->mE:Landroid/view/View;
...
.method static synthetic a(Landroid/support/v7/internal/view/menu/k;)Z
    ...
    .prologue
    .line 45
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/k;->mF:Z
...
.method static synthetic b(Landroid/support/v7/internal/view/menu/k;)Landroid/view/LayoutInflater;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->hE:Landroid/view/LayoutInflater;
...
.method static synthetic c(Landroid/support/v7/internal/view/menu/k;)Landroid/support/v7/internal/view/menu/f;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->iK:Landroid/support/v7/internal/view/menu/f;
...
.method public final a(Landroid/support/v7/internal/view/menu/f;Z)V
    ...
    .line 268
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->me:Landroid/support/v7/internal/view/menu/l$a;
...
.method public final a(Landroid/support/v7/internal/view/menu/p;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/k;->mE:Landroid/view/View;
    ...
    iput-object v0, v3, Landroid/support/v7/internal/view/menu/k;->me:Landroid/support/v7/internal/view/menu/l$a;
    ...
    .line 248
    :goto_1
    iput-boolean v0, v3, Landroid/support/v7/internal/view/menu/k;->lz:Z

    .line 250
    invoke-virtual {v3}, Landroid/support/v7/internal/view/menu/k;->bT()Z
...
.method public final bT()Z
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mC:Landroid/support/v7/internal/widget/ListPopupWindow;

    .line 110
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mC:Landroid/support/v7/internal/widget/ListPopupWindow;
    ...
    iput-object p0, v0, Landroid/support/v7/internal/widget/ListPopupWindow;->pW:Landroid/widget/AdapterView$OnItemClickListener;

    .line 113
    new-instance v0, Landroid/support/v7/internal/view/menu/k$a;

    iget-object v4, p0, Landroid/support/v7/internal/view/menu/k;->iK:Landroid/support/v7/internal/view/menu/f;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mH:Landroid/support/v7/internal/view/menu/k$a;

    .line 114
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mC:Landroid/support/v7/internal/widget/ListPopupWindow;

    iget-object v4, p0, Landroid/support/v7/internal/view/menu/k;->mH:Landroid/support/v7/internal/view/menu/k$a;
    ...
    .line 119
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mG:Landroid/view/ViewTreeObserver;
    ...
    iput-object v5, p0, Landroid/support/v7/internal/view/menu/k;->mG:Landroid/view/ViewTreeObserver;
    ...
    iput-object v4, v0, Landroid/support/v7/internal/widget/ListPopupWindow;->pU:Landroid/view/View;

    .line 129
    iget-object v7, p0, Landroid/support/v7/internal/view/menu/k;->mC:Landroid/support/v7/internal/widget/ListPopupWindow;

    iget-object v8, p0, Landroid/support/v7/internal/view/menu/k;->mH:Landroid/support/v7/internal/view/menu/k$a;
    ...
    :goto_2
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/k;->mI:Landroid/view/ViewGroup;
    ...
    iput-object v4, p0, Landroid/support/v7/internal/view/menu/k;->mI:Landroid/view/ViewGroup;
    ...
    .line 129
    :cond_4
    iget v0, p0, Landroid/support/v7/internal/view/menu/k;->mD:I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ListPopupWindow;->cr()V
    ...
    iget-object v0, v0, Landroid/support/v7/internal/widget/ListPopupWindow;->pI:Landroid/support/v7/internal/widget/ListPopupWindow$a;
...
.method public onDismiss()V
    ...
    .line 143
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/k;->mC:Landroid/support/v7/internal/widget/ListPopupWindow;
    ...
    .line 147
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mE:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mG:Landroid/view/ViewTreeObserver;
    ...
    .line 150
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/k;->mG:Landroid/view/ViewTreeObserver;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 160
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/k;->mH:Landroid/support/v7/internal/view/menu/k$a;
