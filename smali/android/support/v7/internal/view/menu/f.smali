...
.field final lH:Landroid/content/res/Resources;

.field private lI:Z

.field private lJ:Z

.field lK:Landroid/support/v7/internal/view/menu/f$a;
...
.field private lR:Landroid/view/ContextMenu$ContextMenuInfo;

.field lS:Ljava/lang/CharSequence;

.field lT:Landroid/graphics/drawable/Drawable;
...
.field private lZ:Ljava/util/ArrayList;

.field final mContext:Landroid/content/Context;

.field private ma:Ljava/util/concurrent/CopyOnWriteArrayList;

.field mb:Landroid/support/v7/internal/view/menu/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/internal/view/menu/f;->lG:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 115
    iput v1, p0, Landroid/support/v7/internal/view/menu/f;->lQ:I

    .line 143
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->lV:Z

    .line 145
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->lW:Z

    .line 147
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->lX:Z

    .line 149
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->lY:Z
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->lZ:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->ma:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->lH:Landroid/content/res/Resources;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->lL:Ljava/util/ArrayList;

    .line 200
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lM:Z
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->lN:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/f;->lO:Ljava/util/ArrayList;

    .line 204
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lP:Z

    .line 206
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/f;->lH:Landroid/content/res/Resources;
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lJ:Z
...
.method private a(ILandroid/view/KeyEvent;)Landroid/support/v7/internal/view/menu/h;
    ...
    .line 872
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/f;->lZ:Ljava/util/ArrayList;
    ...
    .line 891
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bB()Z
...
.method private a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    sget-object v1, Landroid/support/v7/internal/view/menu/f;->lG:[I
    ...
    iget v7, p0, Landroid/support/v7/internal/view/menu/f;->lQ:I
    ...
    .line 406
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->lR:Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    iput-object v1, v0, Landroid/support/v7/internal/view/menu/h;->mm:Landroid/view/ContextMenu$ContextMenuInfo;
...
.method private static b(Ljava/util/ArrayList;I)I
    ...
    .line 793
    iget v0, v0, Landroid/support/v7/internal/view/menu/h;->kh:I
...
.method public a(Landroid/support/v7/internal/view/menu/f$a;)V
    ...
    .prologue
    .line 394
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->lK:Landroid/support/v7/internal/view/menu/f$a;
...
.method public final a(Landroid/support/v7/internal/view/menu/l;)V
    ...
    .prologue
    .line 221
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->ma:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method final a(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    .line 1158
    iput-object p3, p0, Landroid/support/v7/internal/view/menu/f;->lU:Landroid/view/View;

    .line 1161
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lS:Ljava/lang/CharSequence;

    .line 1162
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lT:Landroid/graphics/drawable/Drawable;
    ...
    .line 1167
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->lS:Ljava/lang/CharSequence;
    ...
    .line 1173
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/f;->lT:Landroid/graphics/drawable/Drawable;

    .line 1177
    :cond_2
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lU:Landroid/view/View;
...
.method a(Landroid/support/v7/internal/view/menu/f;Landroid/view/MenuItem;)Z
    ...
    .prologue
    .line 778
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lK:Landroid/support/v7/internal/view/menu/f$a;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lK:Landroid/support/v7/internal/view/menu/f$a;

    invoke-interface {v0, p2}, Landroid/support/v7/internal/view/menu/f$a;->f(Landroid/view/MenuItem;)Z
...
.method public add(I)Landroid/view/MenuItem;
    ...
    .line 424
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lH:Landroid/content/res/Resources;
...
.method public final b(Landroid/support/v7/internal/view/menu/l;)V
    ...
    .line 236
    :cond_1
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->ma:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method bB()Z
    ...
    .prologue
    .line 737
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lI:Z
...
.method public bC()Z
    ...
    .prologue
    .line 766
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lJ:Z
...
.method public final bD()V
    ...
    .prologue
    .line 1012
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lV:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lV:Z

    .line 1014
    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lW:Z
...
.method public final bE()V
    ...
    .line 1021
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lW:Z
...
.method final bG()Ljava/util/ArrayList;
    .locals 5
    ...
    .line 1051
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lL:Ljava/util/ArrayList;
    ...
    .line 1062
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/f;->lL:Ljava/util/ArrayList;
    ...
    .line 1066
    :cond_2
    iput-boolean v2, p0, Landroid/support/v7/internal/view/menu/f;->lM:Z
...
.method public final bH()V
    ...
    .line 1097
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lP:Z
    ...
    .line 1108
    :cond_1
    invoke-interface {v1}, Landroid/support/v7/internal/view/menu/l;->bv()Z
    ...
    .line 1113
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lN:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 1114
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->lO:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 1115
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bG()Ljava/util/ArrayList;
    ...
    .line 1119
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/h;->bO()Z
    ...
    .line 1120
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/f;->lN:Ljava/util/ArrayList;
    ...
    .line 1122
    :cond_3
    iget-object v5, p0, Landroid/support/v7/internal/view/menu/f;->lO:Ljava/util/ArrayList;
    ...
    .line 1132
    :cond_5
    iput-boolean v3, p0, Landroid/support/v7/internal/view/menu/f;->lP:Z

    goto :goto_0
.end method

.method final bI()Ljava/util/ArrayList;
    .locals 1

    .prologue
    .line 1141
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bH()V
...
.method public bJ()Landroid/support/v7/internal/view/menu/f;
    .locals 0
...
.method public final c(Landroid/view/MenuItem;I)Z
    ...
    .line 923
    :cond_2
    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/h;->bL()Z
    ...
    .line 940
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/f;->ma:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public clear()V
    ...
    .prologue
    .line 548
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->mb:Landroid/support/v7/internal/view/menu/h;
...
.method public f(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    .line 1291
    :cond_1
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bD()V
    ...
    .line 1297
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/f;->bE()V

    .line 1302
    if-eqz v0, :cond_0

    .line 1303
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->mb:Landroid/support/v7/internal/view/menu/h;
...
.method public g(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->mb:Landroid/support/v7/internal/view/menu/h;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/f;->mb:Landroid/support/v7/internal/view/menu/h;
...
.method final r(Z)V
    ...
    .prologue
    .line 965
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lY:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/f;->lY:Z
...
.method final s(Z)V
    ...
    .line 996
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->lM:Z

    .line 997
    iput-boolean v1, p0, Landroid/support/v7/internal/view/menu/f;->lP:Z
...
.method public setQwertyMode(Z)V
    ...
    .prologue
    .line 708
    iput-boolean p1, p0, Landroid/support/v7/internal/view/menu/f;->lI:Z
