...
.field protected iK:Landroid/support/v7/internal/view/menu/f;

.field protected lf:Landroid/content/Context;

.field protected lg:Landroid/view/LayoutInflater;

.field public lh:Landroid/support/v7/internal/view/menu/l$a;

.field private li:I

.field private lj:I

.field protected lk:Landroid/support/v7/internal/view/menu/m;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 57
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/b;->lf:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/b;->lg:Landroid/view/LayoutInflater;

    .line 59
    const v0, 0x7f030009

    iput v0, p0, Landroid/support/v7/internal/view/menu/b;->li:I

    .line 60
    const v0, 0x7f030008

    iput v0, p0, Landroid/support/v7/internal/view/menu/b;->lj:I
...
.method public a(Landroid/support/v7/internal/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 178
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->lg:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/internal/view/menu/b;->lj:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/f;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/b;->hE:Landroid/view/LayoutInflater;

    .line 67
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/b;->iK:Landroid/support/v7/internal/view/menu/f;
...
.method public a(Landroid/support/v7/internal/view/menu/f;Z)V
    ...
    .prologue
    .line 204
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->lh:Landroid/support/v7/internal/view/menu/l$a;
...
.method public b(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/m;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->lk:Landroid/support/v7/internal/view/menu/m;
    ...
    iget v1, p0, Landroid/support/v7/internal/view/menu/b;->li:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/b;->lk:Landroid/support/v7/internal/view/menu/m;

    .line 73
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/b;->lk:Landroid/support/v7/internal/view/menu/m;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/b;->iK:Landroid/support/v7/internal/view/menu/f;
...
.method public q(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/f;->bG()Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/b;->lk:Landroid/support/v7/internal/view/menu/m;
