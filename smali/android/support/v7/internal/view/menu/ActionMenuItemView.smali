...
.field private ks:Landroid/support/v7/internal/view/menu/f$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 68
    sget-object v0, Lcom/tencent/mm/a$b;->ActionMenuItemView:[I
    ...
    iput v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kv:I
    ...
    iput v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kw:I
...
.method private bp()V
    ...
    .line 135
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ki:Ljava/lang/CharSequence;
    ...
    .line 136
    :goto_0
    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kr:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kq:Landroid/support/v7/internal/view/menu/h;

    iget v3, v3, Landroid/support/v7/internal/view/menu/h;->mh:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kt:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ku:Z
...
.method public final a(Landroid/support/v7/internal/view/menu/h;)V
    ...
    .prologue
    .line 93
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kq:Landroid/support/v7/internal/view/menu/h;
...
.method public final bq()Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kq:Landroid/support/v7/internal/view/menu/h;
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 104
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ks:Landroid/support/v7/internal/view/menu/f$b;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kq:Landroid/support/v7/internal/view/menu/h;
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 194
    iget-object v9, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kq:Landroid/support/v7/internal/view/menu/h;
...
.method protected onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kw:I
    ...
    iget v4, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kv:I
    ...
    iget v2, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kv:I
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kr:Landroid/graphics/drawable/Drawable;
    ...
    .line 233
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kr:Landroid/graphics/drawable/Drawable;
    ...
    .line 220
    :cond_3
    iget v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kv:I
...
.method public setExpandedFormat(Z)V
    ...
    .prologue
    .line 126
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ku:Z

    if-eq v0, p1, :cond_0

    .line 127
    iput-boolean p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ku:Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 143
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kr:Landroid/graphics/drawable/Drawable;
    ...
    .line 146
    invoke-direct {p0}, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->bp()V
...
.method public setItemInvoker(Landroid/support/v7/internal/view/menu/f$b;)V
    ...
    .prologue
    .line 110
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ks:Landroid/support/v7/internal/view/menu/f$b;
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 84
    iput p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->kw:I
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 158
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->ki:Ljava/lang/CharSequence;
