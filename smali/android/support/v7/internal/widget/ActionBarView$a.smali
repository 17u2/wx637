...
.field final synthetic od:Landroid/support/v7/internal/widget/ActionBarView;

.field public oe:Landroid/support/v7/internal/view/menu/h;
...
.method private constructor <init>(Landroid/support/v7/internal/widget/ActionBarView;)V
    ...
    .prologue
    .line 1367
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->od:Landroid/support/v7/internal/widget/ActionBarView;
...
.method public final a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/f;)V
    ...
    .prologue
    .line 1375
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->iK:Landroid/support/v7/internal/view/menu/f;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->oe:Landroid/support/v7/internal/view/menu/h;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->oe:Landroid/support/v7/internal/view/menu/h;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/f;->g(Landroid/support/v7/internal/view/menu/h;)Z

    .line 1378
    :cond_0
    iput-object p2, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->iK:Landroid/support/v7/internal/view/menu/f;
...
.method public final d(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    .line 1430
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->od:Landroid/support/v7/internal/widget/ActionBarView;

    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/h;->getActionView()Landroid/view/View;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->nY:Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->od:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->od:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    .line 1432
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->oe:Landroid/support/v7/internal/view/menu/h;

    .line 1433
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->od:Landroid/support/v7/internal/widget/ActionBarView;

    iget-object v0, v0, Landroid/support/v7/internal/widget/ActionBarView;->nY:Landroid/view/View;
    ...
    iget-object v1, v1, Landroid/support/v7/internal/widget/ActionBarView;->nY:Landroid/view/View;
...
.method public final e(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    iput-object v3, v0, Landroid/support/v7/internal/widget/ActionBarView;->nY:Landroid/view/View;
    ...
    .line 1493
    iput-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->oe:Landroid/support/v7/internal/view/menu/h;
...
.method public final q(Z)V
    ...
    .line 1396
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->oe:Landroid/support/v7/internal/view/menu/h;
