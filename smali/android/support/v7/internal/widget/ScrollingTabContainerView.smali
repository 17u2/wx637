...
.field nW:Ljava/lang/Runnable;

.field private qH:Landroid/widget/LinearLayout;

.field private qI:Landroid/support/v7/internal/widget/d;
...
.method static synthetic a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/app/ActionBar$c;)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qH:Landroid/widget/LinearLayout;
    ...
    iput-object p0, v0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->qR:Landroid/support/v7/internal/widget/ScrollingTabContainerView;

    iput-object p1, v0, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->qP:Landroid/support/v7/app/ActionBar$c;
    ...
    iget v3, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->mR:I
...
.method static synthetic a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;)Landroid/widget/LinearLayout;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qH:Landroid/widget/LinearLayout;
...
.method private cv()Z
    ...
    .prologue
    .line 129
    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qI:Landroid/support/v7/internal/widget/d;
...
.method private cw()Z
    ...
    .line 158
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->cv()Z
...
.method public final onAttachedToWindow()V
    ...
    .line 222
    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->nW:Ljava/lang/Runnable;
...
.method protected final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {v0}, Landroid/support/v7/internal/view/a;->l(Landroid/content/Context;)Landroid/support/v7/internal/view/a;
    ...
    sget-object v3, Lcom/tencent/mm/Aclz$SubB;->ActionBar:[I
    ...
    iput v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qL:I
...
.method public final onMeasure(II)V
    ...
    .line 84
    iget-object v4, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qH:Landroid/widget/LinearLayout;
    ...
    iput v3, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qK:I

    .line 92
    :goto_1
    iget v3, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qK:I

    iget v4, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qL:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qJ:Z
    ...
    .line 103
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qH:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qI:Landroid/support/v7/internal/widget/d;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qI:Landroid/support/v7/internal/widget/d;
    ...
    iget-object v1, v1, Landroid/support/v7/internal/widget/AbsSpinnerICS;->mT:Landroid/widget/SpinnerAdapter;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->nW:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->nW:Ljava/lang/Runnable;

    :cond_3
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qI:Landroid/support/v7/internal/widget/d;

    iget v2, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qM:I
    ...
    .line 119
    iget v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qM:I
    ...
    .line 94
    :cond_8
    iput v6, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qK:I
    ...
    .line 107
    :cond_a
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->cw()Z
...
.method public final setAllowCollapse(Z)V
    ...
    .prologue
    .line 133
    iput-boolean p1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qJ:Z
...
.method public final setContentHeight(I)V
    ...
    .prologue
    .line 183
    iput p1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->mR:I
...
.method public final setTabSelected(I)V
    ...
    .line 170
    iput p1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->qM:I
    ...
    iget-object v4, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->nW:Ljava/lang/Runnable;
    ...
    iput-object v4, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->nW:Ljava/lang/Runnable;
