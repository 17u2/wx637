...
# instance fields
.field public iB:Landroid/support/v7/app/a;
...
.method private aZ()Z
    ...
    .line 357
    invoke-static {p0}, Landroid/support/v4/app/k;->a(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    .line 360
    invoke-static {p0, v0}, Landroid/support/v4/app/k;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    .line 361
    invoke-static {p0}, Landroid/support/v4/app/aa;->j(Landroid/content/Context;)Landroid/support/v4/app/aa;

    move-result-object v5

    .line 362
    instance-of v0, p0, Landroid/support/v4/app/aa$a;
    ...
    invoke-interface {v0}, Landroid/support/v4/app/aa$a;->ao()Landroid/content/Intent;
    ...
    iget-object v0, v5, Landroid/support/v4/app/aa;->dX:Landroid/content/Context;
    ...
    :cond_0
    invoke-virtual {v5, v0}, Landroid/support/v4/app/aa;->a(Landroid/content/ComponentName;)Landroid/support/v4/app/aa;

    iget-object v0, v5, Landroid/support/v4/app/aa;->dW:Ljava/util/ArrayList;
    ...
    iget-object v3, v5, Landroid/support/v4/app/aa;->dW:Ljava/util/ArrayList;
    ...
    iget-object v3, v5, Landroid/support/v4/app/aa;->dX:Landroid/content/Context;
    ...
    .line 376
    :cond_7
    invoke-static {p0, v0}, Landroid/support/v4/app/k;->b(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public final ao()Landroid/content/Intent;
    .locals 1
...
.method public getMenuInflater()Landroid/view/MenuInflater;
    ...
    iget-object v1, v0, Landroid/support/v7/app/a;->iE:Landroid/view/MenuInflater;
    ...
    iput-object v2, v0, Landroid/support/v7/app/a;->iE:Landroid/view/MenuInflater;

    :cond_0
    :goto_0
    iget-object v0, v0, Landroid/support/v7/app/a;->iE:Landroid/view/MenuInflater;
    ...
    iget-object v2, v0, Landroid/support/v7/app/a;->iC:Landroid/support/v7/app/ActionBarActivity;

    invoke-direct {v1, v2}, Landroid/support/v7/internal/view/c;-><init>(Landroid/content/Context;)V

    iput-object v1, v0, Landroid/support/v7/app/a;->iE:Landroid/view/MenuInflater;
...
.method public onBackPressed()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/a;->bd()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/a;->bc()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/app/ActionBarActivity;->iB:Landroid/support/v7/app/a;
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    .line 124
    invoke-direct {p0}, Landroid/support/v7/app/ActionBarActivity;->aZ()Z
