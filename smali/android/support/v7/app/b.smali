...
# instance fields
.field private iI:Landroid/support/v7/internal/widget/ActionBarView;

.field private iJ:Landroid/support/v7/internal/view/menu/e;

.field private iK:Landroid/support/v7/internal/view/menu/f;

.field private iL:Landroid/support/v7/a/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/app/b;->iH:[I
...
.method static synthetic a(Landroid/support/v7/app/b;)Landroid/support/v7/internal/view/menu/f;
    ...
    .prologue
    .line 45
    invoke-direct {p0}, Landroid/support/v7/app/b;->bh()Landroid/support/v7/internal/view/menu/f;
...
.method static synthetic b(Landroid/support/v7/app/b;)Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/b;->iP:Z

    return v0
.end method

.method private bh()Landroid/support/v7/internal/view/menu/f;
    .locals 2
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/b;->bf()Landroid/content/Context;
...
.method private c(Landroid/support/v7/internal/view/menu/f;)V
    ...
    .prologue
    .line 421
    iget-object v0, p0, Landroid/support/v7/app/b;->iK:Landroid/support/v7/internal/view/menu/f;
    ...
    iget-object v1, p0, Landroid/support/v7/app/b;->iJ:Landroid/support/v7/internal/view/menu/e;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/f;->b(Landroid/support/v7/internal/view/menu/l;)V

    .line 428
    :cond_2
    iput-object p1, p0, Landroid/support/v7/app/b;->iK:Landroid/support/v7/internal/view/menu/f;

    .line 430
    if-eqz p1, :cond_3

    iget-object v0, p0, Landroid/support/v7/app/b;->iJ:Landroid/support/v7/internal/view/menu/e;
    ...
    .line 434
    :cond_3
    iget-object v0, p0, Landroid/support/v7/app/b;->iI:Landroid/support/v7/internal/widget/ActionBarView;
...
.method public final G()V
    ...
    .prologue
    .line 369
    iget-boolean v0, p0, Landroid/support/v7/app/b;->iP:Z
...
.method public final a(Landroid/support/v7/internal/view/menu/f;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ActionBarView;->bV()Z
...
.method public final addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .prologue
    .line 161
    invoke-virtual {p0}, Landroid/support/v7/app/b;->bg()V

    .line 162
    iget-boolean v0, p0, Landroid/support/v7/app/b;->iF:Z
...
.method public ba()Landroid/support/v7/app/ActionBar;
    .locals 3
    ...
    iget-object v1, p0, Landroid/support/v7/app/b;->iC:Landroid/support/v7/app/ActionBarActivity;

    iget-object v2, p0, Landroid/support/v7/app/b;->iC:Landroid/support/v7/app/ActionBarActivity;
...
.method public final bc()V
    ...
    .line 98
    invoke-virtual {p0}, Landroid/support/v7/app/b;->bb()Landroid/support/v7/app/ActionBar;
    ...
    invoke-static {v1}, Landroid/support/v7/internal/view/a;->l(Landroid/content/Context;)Landroid/support/v7/internal/view/a;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/v7/internal/view/a;->bk()Z
...
.method public final bd()Z
    ...
    .line 442
    iget-object v2, p0, Landroid/support/v7/app/b;->iL:Landroid/support/v7/a/a;

    if-eqz v2, :cond_1

    .line 443
    iget-object v1, p0, Landroid/support/v7/app/b;->iL:Landroid/support/v7/a/a;
    ...
    .line 448
    :cond_1
    iget-object v2, p0, Landroid/support/v7/app/b;->iI:Landroid/support/v7/internal/widget/ActionBarView;

    if-eqz v2, :cond_4

    iget-object v2, p0, Landroid/support/v7/app/b;->iI:Landroid/support/v7/internal/widget/ActionBarView;

    iget-object v3, v2, Landroid/support/v7/internal/widget/ActionBarView;->nX:Landroid/support/v7/internal/widget/ActionBarView$a;

    if-eqz v3, :cond_2

    iget-object v2, v2, Landroid/support/v7/internal/widget/ActionBarView;->nX:Landroid/support/v7/internal/widget/ActionBarView$a;

    iget-object v2, v2, Landroid/support/v7/internal/widget/ActionBarView$a;->oe:Landroid/support/v7/internal/view/menu/h;
    ...
    .line 449
    iget-object v1, p0, Landroid/support/v7/app/b;->iI:Landroid/support/v7/internal/widget/ActionBarView;

    iget-object v2, v1, Landroid/support/v7/internal/widget/ActionBarView;->nX:Landroid/support/v7/internal/widget/ActionBarView$a;
    ...
    .line 449
    :cond_3
    iget-object v1, v1, Landroid/support/v7/internal/widget/ActionBarView;->nX:Landroid/support/v7/internal/widget/ActionBarView$a;

    iget-object v1, v1, Landroid/support/v7/internal/widget/ActionBarView$a;->oe:Landroid/support/v7/internal/view/menu/h;
...
.method final bg()V
    ...
    .line 173
    iget-boolean v0, p0, Landroid/support/v7/app/b;->iG:Z
    ...
    iput-object v0, p0, Landroid/support/v7/app/b;->iI:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    .line 184
    iget-boolean v0, p0, Landroid/support/v7/app/b;->iN:Z
    ...
    iget v3, v0, Landroid/support/v7/internal/widget/ActionBarView;->nM:I

    invoke-direct {v1, v2, v3}, Landroid/support/v7/internal/widget/ProgressBarICS;-><init>(Landroid/content/Context;I)V

    iput-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->nI:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    iget v3, v0, Landroid/support/v7/internal/widget/ActionBarView;->nN:I

    invoke-direct {v1, v2, v3}, Landroid/support/v7/internal/widget/ProgressBarICS;-><init>(Landroid/content/Context;I)V

    iput-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->nJ:Landroid/support/v7/internal/widget/ProgressBarICS;

    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->nJ:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/b;->be()Ljava/lang/String;
...
.method public final onCreatePanelView(I)Landroid/view/View;
    ...
    .line 261
    iget-object v1, p0, Landroid/support/v7/app/b;->iK:Landroid/support/v7/internal/view/menu/f;

    .line 263
    iget-object v3, p0, Landroid/support/v7/app/b;->iL:Landroid/support/v7/a/a;
    ...
    .line 273
    invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/f;->bD()V
    ...
    iget-object v3, p0, Landroid/support/v7/app/b;->iK:Landroid/support/v7/internal/view/menu/f;

    if-eqz v3, :cond_4

    iget-object v3, p0, Landroid/support/v7/app/b;->iJ:Landroid/support/v7/internal/view/menu/e;
    ...
    iput-object v3, p0, Landroid/support/v7/app/b;->iJ:Landroid/support/v7/internal/view/menu/e;

    iget-object v3, p0, Landroid/support/v7/app/b;->iJ:Landroid/support/v7/internal/view/menu/e;

    iput-object p0, v3, Landroid/support/v7/internal/view/menu/e;->lh:Landroid/support/v7/internal/view/menu/l$a;

    iget-object v3, p0, Landroid/support/v7/app/b;->iK:Landroid/support/v7/internal/view/menu/f;

    iget-object v4, p0, Landroid/support/v7/app/b;->iJ:Landroid/support/v7/internal/view/menu/e;
    ...
    iget-object v2, v3, Landroid/support/v7/internal/view/menu/e;->lD:Landroid/support/v7/internal/view/menu/e$a;
    ...
    iput-object v2, v3, Landroid/support/v7/internal/view/menu/e;->lD:Landroid/support/v7/internal/view/menu/e$a;
    ...
    iget-object v0, v3, Landroid/support/v7/internal/view/menu/e;->lA:Landroid/support/v7/internal/view/menu/ExpandedMenuView;

    if-nez v0, :cond_3

    iget-object v0, v3, Landroid/support/v7/internal/view/menu/e;->hE:Landroid/view/LayoutInflater;
    ...
    iput-object v0, v3, Landroid/support/v7/internal/view/menu/e;->lA:Landroid/support/v7/internal/view/menu/ExpandedMenuView;
