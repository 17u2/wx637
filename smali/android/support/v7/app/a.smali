...
# instance fields
.field final iC:Landroid/support/v7/app/ActionBarActivity;

.field private iD:Landroid/support/v7/app/ActionBar;

.field iE:Landroid/view/MenuInflater;
...
.method constructor <init>(Landroid/support/v7/app/ActionBarActivity;)V
    ...
    .line 67
    iput-object p1, p0, Landroid/support/v7/app/a;->iC:Landroid/support/v7/app/ActionBarActivity;
...
.method public final bb()Landroid/support/v7/app/ActionBar;
    ...
    .prologue
    .line 75
    iget-boolean v0, p0, Landroid/support/v7/app/a;->iF:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Landroid/support/v7/app/a;->iG:Z

    if-eqz v0, :cond_2

    .line 76
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/a;->iD:Landroid/support/v7/app/ActionBar;

    if-nez v0, :cond_1

    .line 77
    invoke-virtual {p0}, Landroid/support/v7/app/a;->ba()Landroid/support/v7/app/ActionBar;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/a;->iD:Landroid/support/v7/app/ActionBar;
...
.method protected final be()Ljava/lang/String;
    ...
    .line 157
    :try_start_0
    iget-object v1, p0, Landroid/support/v7/app/a;->iC:Landroid/support/v7/app/ActionBarActivity;
    ...
    .line 158
    iget-object v2, p0, Landroid/support/v7/app/a;->iC:Landroid/support/v7/app/ActionBarActivity;
...
.method protected final bf()Landroid/content/Context;
    ...
    .line 177
    invoke-virtual {p0}, Landroid/support/v7/app/a;->bb()Landroid/support/v7/app/ActionBar;
...
.method onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/app/a;->iF:Z
    ...
    iput-boolean v1, p0, Landroid/support/v7/app/a;->iG:Z
