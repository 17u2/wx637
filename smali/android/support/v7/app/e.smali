...
.field private iC:Landroid/support/v7/app/ActionBarActivity;
...
.field private jo:Landroid/support/v7/app/ActionBar$a;
...
.method public constructor <init>(Landroid/support/v7/app/ActionBarActivity;Landroid/support/v7/app/ActionBar$a;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->ca:Ljava/util/ArrayList;

    .line 73
    const/4 v0, -0x1

    iput v0, p0, Landroid/support/v7/app/e;->jd:I
    ...
    .line 102
    iput-boolean v1, p0, Landroid/support/v7/app/e;->jm:Z

    .line 108
    iput-object p1, p0, Landroid/support/v7/app/e;->iC:Landroid/support/v7/app/ActionBarActivity;

    .line 109
    iput-object p1, p0, Landroid/support/v7/app/e;->mContext:Landroid/content/Context;

    .line 110
    iput-object p2, p0, Landroid/support/v7/app/e;->jo:Landroid/support/v7/app/ActionBar$a;

    .line 111
    iget-object v3, p0, Landroid/support/v7/app/e;->iC:Landroid/support/v7/app/ActionBarActivity;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->iW:Landroid/support/v7/internal/widget/ActionBarOverlayLayout;

    iget-object v0, p0, Landroid/support/v7/app/e;->iW:Landroid/support/v7/internal/widget/ActionBarOverlayLayout;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->iZ:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->ja:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->iX:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->iY:Landroid/view/ViewGroup;

    iget-object v0, p0, Landroid/support/v7/app/e;->iY:Landroid/view/ViewGroup;

    if-nez v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/app/e;->iX:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    iget-object v0, p0, Landroid/support/v7/app/e;->iZ:Landroid/support/v7/internal/widget/ActionBarView;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/app/e;->ja:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    iget-object v3, p0, Landroid/support/v7/app/e;->ja:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ActionBarView;->ca()Z
    ...
    :goto_0
    iput v0, p0, Landroid/support/v7/app/e;->jg:I
    ...
    iput-boolean v1, p0, Landroid/support/v7/app/e;->je:Z

    :cond_5
    iget-object v3, p0, Landroid/support/v7/app/e;->mContext:Landroid/content/Context;

    invoke-static {v3}, Landroid/support/v7/internal/view/a;->l(Landroid/content/Context;)Landroid/support/v7/internal/view/a;
    ...
    invoke-virtual {v3}, Landroid/support/v7/internal/view/a;->bk()Z

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/app/e;->o(Z)V

    iget-object v0, p0, Landroid/support/v7/app/e;->iC:Landroid/support/v7/app/ActionBarActivity;

    invoke-virtual {v0}, Landroid/support/v7/app/ActionBarActivity;->getTitle()Ljava/lang/CharSequence;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v7/app/e;->iZ:Landroid/support/v7/internal/widget/ActionBarView;
...
.method public final aV()V
    ...
    iget-object v2, p0, Landroid/support/v7/app/e;->iZ:Landroid/support/v7/internal/widget/ActionBarView;
...
.method final bi()V
    ...
    .line 961
    iget-boolean v2, p0, Landroid/support/v7/app/e;->jj:Z

    iget-boolean v3, p0, Landroid/support/v7/app/e;->jk:Z
    ...
    .line 964
    iget-boolean v2, p0, Landroid/support/v7/app/e;->jm:Z

    if-nez v2, :cond_3

    .line 965
    iput-boolean v0, p0, Landroid/support/v7/app/e;->jm:Z

    .line 966
    iget-object v2, p0, Landroid/support/v7/app/e;->iY:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/e;->bj()Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/e;->iY:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Landroid/support/v7/app/e;->jb:Landroid/support/v7/internal/widget/ActionBarContainer;
    ...
    :cond_7
    iget-object v1, p0, Landroid/support/v7/app/e;->iY:Landroid/view/ViewGroup;

    invoke-virtual {v1, v5}, Landroid/view/ViewGroup;->setVisibility(I)V

    iget-object v1, p0, Landroid/support/v7/app/e;->jb:Landroid/support/v7/internal/widget/ActionBarContainer;
...
.method public final getThemedContext()Landroid/content/Context;
    ...
    .prologue
    .line 503
    iget-object v0, p0, Landroid/support/v7/app/e;->iV:Landroid/content/Context;
    ...
    iput-object v1, p0, Landroid/support/v7/app/e;->iV:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/app/e;->iV:Landroid/content/Context;
...
.method public hide()V
    ...
    .prologue
    .line 540
    iget-boolean v0, p0, Landroid/support/v7/app/e;->jj:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/e;->jj:Z

    .line 542
    invoke-virtual {p0}, Landroid/support/v7/app/e;->bi()V
...
.method public final isShowing()Z
    ...
    .prologue
    .line 555
    iget-boolean v0, p0, Landroid/support/v7/app/e;->jm:Z
...
.method final o(Z)V
    ...
    .line 156
    iput-boolean p1, p0, Landroid/support/v7/app/e;->jh:Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/e;->jc:Landroid/support/v7/internal/widget/ScrollingTabContainerView;
    ...
    :cond_0
    :goto_2
    iget-object v3, p0, Landroid/support/v7/app/e;->iZ:Landroid/support/v7/internal/widget/ActionBarView;

    iget-boolean v4, p0, Landroid/support/v7/app/e;->jh:Z
...
.method public final p(Z)V
    ...
    .prologue
    .line 977
    iput-boolean p1, p0, Landroid/support/v7/app/e;->jn:Z
