...
.method public final G()V
    ...
    iput-object v0, p0, Landroid/support/v7/app/d;->iS:Landroid/view/Menu;
...
.method public final addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .prologue
    .line 121
    iget-object v0, p0, Landroid/support/v7/app/d;->iC:Landroid/support/v7/app/ActionBarActivity;
...
.method public final ba()Landroid/support/v7/app/ActionBar;
    ...
    iget-object v1, p0, Landroid/support/v7/app/d;->iC:Landroid/support/v7/app/ActionBarActivity;

    iget-object v2, p0, Landroid/support/v7/app/d;->iC:Landroid/support/v7/app/ActionBarActivity;
...
.method public final onActionModeFinished(Landroid/view/ActionMode;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/d;->bf()Landroid/content/Context;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/d;->be()Ljava/lang/String;
    ...
    .line 60
    iget-boolean v0, p0, Landroid/support/v7/app/d;->iF:Z
    ...
    .line 65
    :cond_1
    iget-boolean v0, p0, Landroid/support/v7/app/d;->iG:Z
...
.method public final onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    .line 138
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/d;->iS:Landroid/view/Menu;

    if-nez v0, :cond_1

    .line 139
    invoke-static {p2}, Landroid/support/v7/internal/view/menu/n;->c(Landroid/view/Menu;)Landroid/view/Menu;
    ...
    iget-object v1, p0, Landroid/support/v7/app/d;->iS:Landroid/view/Menu;
