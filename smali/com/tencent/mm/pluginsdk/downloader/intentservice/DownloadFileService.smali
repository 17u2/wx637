...
.field private hKv:Landroid/os/ResultReceiver;
...
.method private a(Ljava/lang/String;Ljava/io/File;)V
    ...
    .line 88
    iget v5, p0, Lcom/tencent/mm/pluginsdk/downloader/intentservice/DownloadFileService;->hKw:I

    add-int/2addr v4, v5

    iput v4, p0, Lcom/tencent/mm/pluginsdk/downloader/intentservice/DownloadFileService;->hKw:I
    ...
    iget v6, p0, Lcom/tencent/mm/pluginsdk/downloader/intentservice/DownloadFileService;->crU:I
    ...
    iget-object v6, p0, Lcom/tencent/mm/pluginsdk/downloader/intentservice/DownloadFileService;->hKv:Landroid/os/ResultReceiver;

    const/16 v7, 0x1231

    invoke-virtual {v6, v7, v4}, Landroid/os/ResultReceiver;->send(ILandroid/os/Bundle;)V

    iput v5, p0, Lcom/tencent/mm/pluginsdk/downloader/intentservice/DownloadFileService;->crU:I
    :try_end_2
...
.method public onCreate()V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/o$d;-><init>(Landroid/content/Context;)V

    .line 39
    const-string/jumbo v1, "Something Download"

    invoke-virtual {v0, v1}, Landroid/support/v4/app/o$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/o$d;

    move-result-object v1

    const-string/jumbo v2, "Download in progress"

    invoke-virtual {v1, v2}, Landroid/support/v4/app/o$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/o$d;

    move-result-object v1

    const v2, 0x7f020357

    invoke-virtual {v1, v2}, Landroid/support/v4/app/o$d;->l(I)Landroid/support/v4/app/o$d;

    .line 44
    const/16 v1, 0x1231

    invoke-virtual {v0}, Landroid/support/v4/app/o$d;->build()Landroid/app/Notification;
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lcom/tencent/mm/pluginsdk/downloader/intentservice/DownloadFileService;->hKv:Landroid/os/ResultReceiver;
