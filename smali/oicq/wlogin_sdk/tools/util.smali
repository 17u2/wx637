...
.field public static lfU:Loicq/wlogin_sdk/tools/b;

.field public static lfV:Z

.field public static lfW:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Loicq/wlogin_sdk/tools/util;->lfC:I

    .line 60
    const/16 v0, 0x80

    sput v0, Loicq/wlogin_sdk/tools/util;->lfD:I

    .line 62
    sput v1, Loicq/wlogin_sdk/tools/util;->lfE:I

    .line 63
    sput v2, Loicq/wlogin_sdk/tools/util;->lfF:I

    .line 64
    const/4 v0, 0x2

    sput v0, Loicq/wlogin_sdk/tools/util;->lfG:I

    .line 65
    const/4 v0, 0x3

    sput v0, Loicq/wlogin_sdk/tools/util;->lfH:I

    .line 66
    const/4 v0, 0x4

    sput v0, Loicq/wlogin_sdk/tools/util;->lfI:I

    .line 67
    sput v3, Loicq/wlogin_sdk/tools/util;->lfJ:I

    .line 68
    const/4 v0, 0x6

    sput v0, Loicq/wlogin_sdk/tools/util;->lfK:I

    .line 69
    const/4 v0, 0x7

    sput v0, Loicq/wlogin_sdk/tools/util;->lfL:I

    .line 70
    const/16 v0, 0x8

    sput v0, Loicq/wlogin_sdk/tools/util;->lfM:I

    .line 71
    const/16 v0, 0x9

    sput v0, Loicq/wlogin_sdk/tools/util;->lfN:I

    .line 72
    const/16 v0, 0xa

    sput v0, Loicq/wlogin_sdk/tools/util;->lfO:I

    .line 73
    const/16 v0, 0xb

    sput v0, Loicq/wlogin_sdk/tools/util;->lfP:I

    .line 74
    const/16 v0, 0xc

    sput v0, Loicq/wlogin_sdk/tools/util;->lfQ:I

    .line 75
    const/16 v0, 0xd

    sput v0, Loicq/wlogin_sdk/tools/util;->lfR:I

    .line 76
    const/16 v0, 0xe

    sput v0, Loicq/wlogin_sdk/tools/util;->lfS:I

    .line 79
    sput v2, Loicq/wlogin_sdk/tools/util;->lfT:I

    .line 83
    const/4 v0, 0x0

    sput-object v0, Loicq/wlogin_sdk/tools/util;->lfU:Loicq/wlogin_sdk/tools/b;

    .line 84
    sput-boolean v1, Loicq/wlogin_sdk/tools/util;->lfV:Z

    .line 86
    sput v3, Loicq/wlogin_sdk/tools/util;->lfW:I
...
.method public static Bz(Ljava/lang/String;)V
    ...
    .line 517
    :try_start_0
    sget v0, Loicq/wlogin_sdk/tools/util;->lfT:I

    if-lt v0, v1, :cond_0

    .line 519
    sget-object v0, Loicq/wlogin_sdk/tools/util;->lfU:Loicq/wlogin_sdk/tools/b;
    ...
    .line 522
    :cond_1
    sget-boolean v0, Loicq/wlogin_sdk/tools/util;->lfV:Z
    ...
    invoke-static {}, Loicq/wlogin_sdk/tools/util;->bgw()Ljava/lang/String;
...
.method public static RSAPrivKeyFromJNI([B)Ljava/security/Key;
    ...
    invoke-static {v0}, Loicq/wlogin_sdk/tools/util;->e(Ljava/lang/Exception;)V
...
.method public static a(Landroid/content/Context;[B)V
    ...
    .prologue
    .line 381
    invoke-static {p0}, Loicq/wlogin_sdk/tools/util;->fO(Landroid/content/Context;)[B
    ...
    invoke-static {p1}, Loicq/wlogin_sdk/tools/util;->bs([B)Ljava/lang/String;
...
.method private static bgw()Ljava/lang/String;
    .locals 3
...
.method public static bo(Landroid/content/Context;Ljava/lang/String;)[B
    .locals 4
    ...
    invoke-static {v0}, Loicq/wlogin_sdk/tools/c;->bq([B)[B
    :try_end_0
...
.method public static br([B)[B
    ...
    .line 178
    invoke-static {v1}, Loicq/wlogin_sdk/tools/c;->bq([B)[B
...
.method public static e(Ljava/lang/Exception;)V
    ...
    invoke-static {v1, v0}, Loicq/wlogin_sdk/tools/util;->cE(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static fO(Landroid/content/Context;)[B
    .locals 5
    ...
    invoke-static {v0}, Loicq/wlogin_sdk/tools/util;->Gu(Ljava/lang/String;)[B
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1}, Loicq/wlogin_sdk/tools/util;->Bz(Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Loicq/wlogin_sdk/tools/util;->cE(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Loicq/wlogin_sdk/tools/util;->bs([B)Ljava/lang/String;
...
.method public static fP(Landroid/content/Context;)[B
    .locals 6
    ...
    invoke-static {v1}, Loicq/wlogin_sdk/tools/util;->Gu(Ljava/lang/String;)[B
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v1}, Loicq/wlogin_sdk/tools/util;->cE(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static fQ(Landroid/content/Context;)[B
    .locals 1
